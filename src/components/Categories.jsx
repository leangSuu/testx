                ...
                <div className="w-full py-10 grid gap-6 md:grid-cols-2">
                    <div className="h-[270px] md:h-[300px] lg:h-[450px]  relative ">
                        <div className="w-full h-[85%] bg-black  border-2  border-black rounded-[25px] overflow-hidden">
                            <img src="public/banner/b1.png" alt="" className="h-full object-cover w-full" />
                    ...
                    <div className="h-[270px] md:h-[300px] lg:h-[450px]  relative ">
                        <div className="w-full h-[85%] bg-black  border-2  border-black rounded-[25px] overflow-hidden">
                            <img src="public/banner/b2.png" alt="" className="h-full object-cover w-full" />
                            <div className="absolute w-[90%] h-[100px] left-1/2 -translate-x-1/2 bg-white shadow-sm rounded-[25px] bottom-0">
                                <div className="flexn justify-center items-center">
                    ...
                    <div className="h-[270px] md:h-[300px] lg:h-[450px]  relative ">
                        <div className="w-full h-[85%] bg-black  border-2  border-black rounded-[25px] overflow-hidden">
                            <img src="public/banner/b3.png" alt="" className="h-full object-cover w-full" />
                            <div className="absolute w-[90%] h-[100px] left-1/2 -translate-x-1/2 bg-white shadow-sm rounded-[25px] bottom-0">
                                <div className="flexn justify-center items-center">
                    ...
                    <div className="h-[270px] md:h-[300px] lg:h-[450px]  relative ">
                        <div className="w-full h-[85%] bg-black  border-2  border-black rounded-[25px] overflow-hidden">
                            <img src="public/banner/b4.png" alt="" className="h-full object-cover w-full" />
                            <div className="absolute w-[90%] h-[100px] left-1/2 -translate-x-1/2 bg-white shadow-sm rounded-[25px] bottom-0">
